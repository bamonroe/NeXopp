...
fun XoppTheme(
    ...
    // The window's status bar is transparent, so it shows whatever surface is behind it. Match the
    // system icon/text contrast to the theme, otherwise light icons land on a light bar (invisible).
