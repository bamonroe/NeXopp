 ...
 * is applied to the whole app via [XoppTheme][com.nexopp.ui.theme.XoppTheme].
 */
...
data class AppSettings(
     ...
     * folder we can both read and write — see [com.nexopp.audio.AudioStore].
     */
    ...
    /** [pdfCacheLimitMb] in bytes — what [com.nexopp.io.PdfStore] prunes against. */
